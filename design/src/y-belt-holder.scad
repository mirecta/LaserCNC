...
module belt_holder_base(){
 ...
 translate([-60.5,29,-1]) cube([52,7,height]); 
}
...
module belt_holder_holes(){
 translate([-22,29.9,4]) rotate([-90,0,0]) cylinder(h=20, r=2.6, $fn=16);
 translate([-22- 32,0.1,4]) rotate([-90,0,0]) cylinder(h=50, r=2.6, $fn=16);
